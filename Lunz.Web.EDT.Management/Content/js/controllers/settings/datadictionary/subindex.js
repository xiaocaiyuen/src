...
MetronicApp.controller('dataDictionarySubListCtrl', ['$scope', '$ngDataTables', '$apiSettings', '$modal', '$notify', '$location',
    function ($scope, $ngDataTables, $api, $modal, $notify, $location) {
        ...
        var initDataTable = function () {
            $scope.dataTable = $ngDataTables.init({
                ...
                getData: function (paging, success) {
                    $api.SubListDataDictionary(paging, $scope.ParentId, success);
                },
                search: {
                    width: 228,
        ...
        $scope.add = function () {
            $modal.open({
                ...
                controller: 'SubDataDictionaryNewCtrl'
        ...
        $scope.editRow = function (row) {
            ...
            $modal.open({
                ...
                controller: 'SubUpdateDataDictionaryEditCtrl',
                resolve: {
                    entity: function () {
                        return entity;
                    }
